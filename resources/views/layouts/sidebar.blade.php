...
<div x-data="{ openPemasukan: false }"
    ...
    <div class="flex-1 overflow-y-auto py-4">
        <ul class="space-y-2 px-2">
            <!-- Nav Item - Dashboard -->
            <li>
                <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white rounded-md transition-colors {{ request()->routeIs('dashboard') ? 'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white font-semibold' : '' }}">
