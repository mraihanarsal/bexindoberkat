            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-bold">Halaman Kategori</h3>
                    ...
                    <p class="mb-6 text-gray-500 dark:text-gray-400">Ini adalah halaman mockup / dummy untuk Kategori. Anda dapat mengembangkan tabel, form, dan logika aplikasinya di sini dengan sangat mudah sesuai standar Laravel.</p>
